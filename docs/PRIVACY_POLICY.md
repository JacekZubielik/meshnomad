# Privacy Policy for MeshNomad

**Last Updated:** January 11, 2026

## Introduction

MeshNomad ("the App") is an independent, open-source Flutter application for communicating with MeshCore-compatible LoRa mesh networking devices. This Privacy Policy explains how the App handles your information.
...
MeshNomad is open-source software. You can review the complete source code to verify these privacy practices at [the project repository].
...
**Summary**: MeshNomad is a privacy-respecting app that stores all data locally on your device. We do not collect, track, or share your personal information.
